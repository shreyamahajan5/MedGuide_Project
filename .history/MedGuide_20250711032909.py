...
def homepage():
    st.title("<style='font-size:30px; color:white;'>Welcome to MedGuide")
    st.markdown(
        "<h3 style='font-size:30px; color:white;'><b>X-ray analysis for Tuberculosis, COVID-19, and Pneumonia</b></h3>",
        unsafe_allow_html=True
    )
    add_bg_from_url()
