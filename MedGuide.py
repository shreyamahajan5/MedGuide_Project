...
def homepage():
    st.markdown(
        "<h1 style='font-size:50px; color:white; text-align:center;'>Welcome to MedGuide</h1>",
        unsafe_allow_html=True
    )
    st.markdown(
        "<h3 style='font-size:28px; color:white; text-align:center;'>X-ray analysis for Tuberculosis, COVID-19, and Pneumonia</h3>",
        unsafe_allow_html=True
    )
    add_bg_from_url()
...
def xray_upload():
    ...
    uploaded_file = st.file_uploader("Upload your X-ray image (JPEG or PNG): (For demo purposes: Download any chest xray from internet and upload)", type=["jpg", "jpeg", "png"])
